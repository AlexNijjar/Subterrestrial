...
public class SubterrestrialConfig implements ConfigData {
    ...
    public List<CabinConfig> cabinConfig_v1 = Arrays.asList(
            new CabinConfig("default_cabin", true, 6, 3, 3, 42, 10, 20),
            new CabinConfig("deepslate_cabin", true, 6, 3, -64, -3, 10, 20),
            new CabinConfig("desert_cabin", true, 5, 4, 3, 48, 10, 20),
            new CabinConfig("ice_cabin", true, 5, 4, 3, 48, 10, 20),
            new CabinConfig("jungle_cabin", true, 5, 4, 3, 48, 10, 20),
            new CabinConfig("ocean_cabin", true, 15, 5, 32, 44, 10, 20)
    );
